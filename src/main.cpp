      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for (int i = 0; i <  pstx.size(); i++) {
            ...
            // actually the same orientation as a line so it'll be a horizontal-ish line
          ...
          double cte = polyeval(coeffs, 0); // car SHOULD be at (0,0) and angle SHOULD be at 0
          // Recall that psi and px are 0
